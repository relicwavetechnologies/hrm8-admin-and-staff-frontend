          ...
          <div
            className={cn(
              ...
              item.read
                ...
                : item.type?.includes('LEAD_CONVERSION_DECLINED')
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Stay informed with leads, conversions, and commission updates
              </p>
            </div>
          </div>
        </div>
