...
function generateDescription(label: string, category: string): string {
    ...
    const descriptions: Record<string, string> = {
        ...
        'Regions Overview': 'Regional ownership and performance summary',
        'Region List': 'View and manage all configured regions',
        ...
        'Chat': 'Ask AI for HRM8 data insights and statuses',
