                        ...
                        jobsList.map((job) => (
                            <div key={job.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">{job.company || (job as any).companyName || (job as any).company_name}</p>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-xs text-muted-foreground w-20 text-right">
                                        {format(new Date(job.postedAt || (job as any).posted_at || new Date()), 'MMM d')}
                                    </div>
                                </div>
                            </div>
                        ))
