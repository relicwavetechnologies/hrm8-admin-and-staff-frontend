...
const mockAddons: AddonService[] = [
  ...
  },
  {
    id: 'video-interview',
    name: 'AI Interview',
    description: 'AI-powered interview screening service',
    pricingModel: 'per_use',
    basePrice: 0,
    pricePerUnit: 25,
    unitLabel: 'per job',
...
const mockRecruitmentServices: RecruitmentService[] = [
  ...
  },
  {
    ...
    description: 'Senior leadership recruitment with a regional minimum search fee',
  ...
  },
  {
    ...
    name: 'Executive Search (Minimum Fee)',
    description: 'Premium executive recruitment with a regional minimum search fee',
    serviceType: 'executive-search',
    pricingModel: 'flat',
    baseFee: 6000,
    minFee: 6000,
  ...
  },
  {
    ...
    description: 'Custom commercial pricing agreed with HRM8',
    serviceType: 'rpo',
    pricingModel: 'tiered',
    baseFee: 0,
    minFee: 0,
